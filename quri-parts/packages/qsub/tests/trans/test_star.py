...
from quri_parts.qsub.lib.std import CNOT, RX, RY, RZ, H
from quri_parts.qsub.sub import SubBuilder
from quri_parts.qsub.trans.star import STARSetTranspiler

_ALLOWED = {"H", "S", "RZ", "CNOT"}


def test_star_set_transpiler() -> None:
    b = SubBuilder(2)
    q0, q1 = b.qubits
    b.add_op(H, (q0,))
    b.add_op(RX(0.5), (q0,))
